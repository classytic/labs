  ...
  return (
    <>
      ...
      {(() => {
        const [x, y] = P(110, 128);
        return (
          <text x={x} y={y} textAnchor="middle" fontSize={14} fontWeight={700} fill="var(--stage-fg)">
            {m.n.toLocaleString()} draws{m.done ? ' ✓' : ''}
          </text>
        );
      })()}
      {(() => {
      ...
      {(() => {
        ...
        return (
          <text x={x} y={y + 3} textAnchor="end" fontSize={10} fill="var(--stage-muted)">
            100%
          </text>
        );
      })()}
      {(() => {
        ...
        return (
          <text x={x} y={y + 9} textAnchor="end" fontSize={10} fill="var(--stage-muted)">
            0%
          </text>
        );
      })()}
      ...
      {(() => {
        ...
        return (
          <text x={x} y={y + 3} fontSize={11} fontWeight={700} fill="var(--stage-good)">
            true {(trueP * 100).toFixed(0)}%
          </text>
        );
      })()}
      {/* running estimate */}
      ...
      {(() => {
        ...
        return (
          <text x={x} y={y} textAnchor="middle" fontSize={11} fill="var(--stage-muted)">
            running P({labels[0]}) over {m.n.toLocaleString()} draws → settles on the dashed true line
          </text>
        );
      })()}
