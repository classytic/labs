...
export {
  factorial, nPr, nCr, binomial, multinomial, starsAndBars, gcd, lcm,
  ruleOfProduct, ruleOfSum, permutationsWithRepetition, circularPermutations,
  multichoose, combinationsWithRepetition,
