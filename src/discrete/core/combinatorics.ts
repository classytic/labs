...
/** Cartesian product: one choice from every authored option set. Shared by
 * sample-space and combination builders so enumeration order stays stable. */
export function cartesianProduct<T>(sets: readonly (readonly T[])[]): T[][] {
