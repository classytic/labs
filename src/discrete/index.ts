...
// the counting RULEBOOK (formula + analogy + worked-calculator + derivation +
// tricks, as data) and the explained calculators that narrate their working.
export {
  COUNTING_RULES,
  PRODUCT_RULE,
  SUM_RULE,
...
export {
  ...
  type Reduce,
  type Cmp,
} from './sample-space/index.js';
// logic-circuit moved to ICT (a digital-system lab, not discrete maths) + consolidated onto the
// shared src/logic engine — see src/domains/ict/logic-circuit.
...
// the rule of product made tactile: assemble each outcome, fill a rows × cols wall,
// add a variable and watch the total multiply (any authored scenario)
export {
  CombinationStudioLab,
  type CombinationStudioProps,
  type ComboCategory,
  type ComboOption,
} from './combination-studio/index.js';
...
export { ProofBuilderLab, type ProofBuilderProps } from './proof-builder/index.js';
export { InductionLadderLab, type InductionLadderProps } from './induction/index.js';
export { PigeonholeAdversaryLab, type PigeonholeAdversaryProps } from './pigeonhole/index.js';
export type { ProofGraph, ProofNode, ProofState, ProofStrategy } from './proof/index.js';
export { ModularClockLab, type ModularClockProps } from './modular-clock/index.js';
export { InvariantDetectiveLab, type InvariantDetectiveProps } from './invariant/index.js';
export { RecurrenceBuilderLab, type RecurrenceBuilderProps } from './recurrence/index.js';
