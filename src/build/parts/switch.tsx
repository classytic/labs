...
import { SwitchGlyph } from '../../kit/electronics/index.js';
...
export const SWITCH: PartDef = {
  ...
  terminalAt: term2,
  toElems: (i, n) =>
    i.props?.closed ? [{ kind: 'V' as const, n1: n('a'), n2: n('b'), value: 0, id: i.id }] : [],
  render: (i, s) =>
    render2(i, labelOf(i), (cx, cy, h, l) => (
      <SwitchGlyph cx={cx} cy={cy} half={h} live={s.live} closed={!!i.props?.closed} label={l} />
    )),
