...
import { ResistorGlyph } from '../../kit/electronics/index.js';
...
export const RESISTOR: PartDef = {
  ...
  label: 'Resistor',
  pins: ['a', 'b'],
  defaultProps: { ohms: 1000, maxPower: 0.5 },
  controls: [
  ...
  render: (i, s) =>
    render2(i, ohmLabel(num(i.props?.ohms, 1000)), (cx, cy, h, l) => (
      <ResistorGlyph cx={cx} cy={cy} half={h} live={s.live} label={l} />
    )),
};
