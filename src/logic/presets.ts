...
export const LOGIC_PRESETS: Record<string, { title: string; doc: LogicDoc }> = {
  ...
  'nand-not': {
    ...
    doc: {
      inputs: [inp('a', 'A', true)],
      gates: [{ id: 'g', kind: 'NAND', in: ['a', 'a'], label: 'NAND' }],
      outputs: [{ id: 'y', in: 'g', label: 'NOT A' }],
    },
  },
  'nand-and': {
    ...
    doc: {
      inputs: [inp('a', 'A', true), inp('b', 'B', true)],
      gates: [
        { id: 'g1', kind: 'NAND', in: ['a', 'b'] },
        { id: 'g2', kind: 'NAND', in: ['g1', 'g1'] },
      ],
  ...
  'nand-or': {
    ...
    doc: {
      inputs: [inp('a', 'A', true), inp('b', 'B')],
      gates: [
        { id: 'na', kind: 'NAND', in: ['a', 'a'] },
        { id: 'nb', kind: 'NAND', in: ['b', 'b'] },
        { id: 'g', kind: 'NAND', in: ['na', 'nb'] },
      ],
  ...
  'half-adder': {
    ...
    doc: {
      ...
      outputs: [
        ...
        { id: 'C', in: 'carry', label: 'Carry', color: 'var(--stage-warn)' },
      ],
    },
  },
  'full-adder': {
    ...
    doc: {
      ...
      outputs: [
        { id: 'S', in: 'sum', label: 'Sum' },
        { id: 'C', in: 'cout', label: 'Cout', color: 'var(--stage-warn)' },
      ],
    },
  },
};
