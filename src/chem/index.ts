...
export { TitrationLab, type IndicatorKey, type TitrationProps } from './titration/index.js';
...
// Hydrogen-like orbital probability models and nodes; deterministic SVG, no WebGL dependency:
export {
  AtomicOrbitalLab,
  AtomicOrbitalProjectedScene,
  atomicOrbitalActivity,
  type AtomicOrbitalProps,
  type AtomicOrbitalSceneProps,
  type AtomicOrbitalSceneRenderer,
  orbitalCloud,
  orbitalFacts,
  projectOrbital,
  type OrbitalKind,
} from './orbitals/index.js';
export {
  CrystalLatticeLab,
  CrystalLatticeProjectedScene,
  crystalLatticeActivity,
  LATTICE_FACTS,
  latticePoints,
  type CrystalLatticeProps,
  type CrystalLatticeSceneProps,
  type CrystalLatticeSceneRenderer,
  type CrystalLatticeKind,
} from './crystal-lattice/index.js';
export {
  StereochemistryLab,
  StereochemistryProjectedScene,
  stereochemistryActivity,
  CHIRAL_MOLECULES,
  chiralVectors,
  mirrorEnantiomer,
  type StereochemistryProps,
  type StereochemistrySceneProps,
  type StereochemistrySceneRenderer,
  type StereochemistryMolecule,
  type Enantiomer,
} from './stereochemistry/index.js';
export {
  OrbitalOverlapLab,
  OrbitalOverlapProjectedScene,
  orbitalOverlapActivity,
  OVERLAP_FACTS,
  overlapStrength,
  type OrbitalOverlapProps,
  type OrbitalOverlapSceneProps,
  type OrbitalOverlapSceneRenderer,
  type OverlapMode,
  type OverlapPhase,
} from './orbital-overlap/index.js';
// VSEPR / molecular shape / introductory hybridization / polarity in a rotatable projection:
export {
  MolecularGeometryLab,
  molecularGeometryActivity,
  type MolecularGeometryProps,
  type MolecularGeometrySceneProps,
  type MolecularGeometrySceneRenderer,
  MOLECULES,
  molecularDipole,
  projectVector,
  type MoleculeKey,
  type MoleculeSpec,
} from './molecular-geometry/index.js';
