...
export const generatedManifestCatalog: LabManifestCatalogEntry[] = [
  ...
  },
  {
    ...
    label: 'Bank Reconciliation Workbench',
    description: 'Update the cash book first, then reconcile outstanding items until it agrees with the bank statement.',
    category: 'interactive',
    void: true,
    group: 'Accounting',
    domain: 'accounting',
  ...
  {
    key: 'control-account-builder',
    label: 'Control Account Builder',
    description: 'Source journal totals, post them to the correct side, and balance sales and purchases ledger control accounts.',
    category: 'interactive',
    void: true,
    group: 'Accounting',
    domain: 'accounting',
  ...
  {
    key: 'chem-qualitative-analysis',
    tag: 'QualitativeAnalysisBench',
    label: 'Qualitative Analysis Bench',
    description: 'Choose a reagent or gas test, record the diagnostic observation, then identify an unknown ion or gas.',
    category: 'interactive',
    void: true,
    group: 'Chemistry',
    domain: 'chem',
  ...
  {
    key: 'cone-frustum',
    label: 'Frustum: a cone with its top cut off',
    description: 'Slide the cut and hunt for the height that carries away a given share of the volume. The small cone is similar, so the share is k³ and halfway up removes only an eighth.',
    category: 'interactive',
    void: true,
  ...
  {
    key: 'log-law-workbench',
    label: 'Log Law Workbench',
  ...
  {
    key: 'vector-geometry-two-d',
    tag: 'VectorGeometry2D',
    label: 'Vector Geometry 2D',
  ...
  {
    key: 'physics-practical-studio',
    label: 'Physics Practical Studio',
    description: 'Plan a fair pendulum test, select apparatus, collect repeated measurements, prepare graph evidence and evaluate uncertainty.',
    category: 'interactive',
    void: true,
    group: 'Physics',
    domain: 'physics',
