...
export function DotCluster({
  ...
  highlight = 0,
  size = 120,
  color = 'color-mix(in oklab, var(--stage-fg) 55%, transparent)',
  highlightColor = 'var(--stage-accent)',
  emphasis = false,
  label,
  value,
  ...
  return (
    ...
    >
      {label && (
        <text x={cx} y={14} fontSize={13} fontWeight={700} fill="var(--stage-fg)" textAnchor="middle">
          {label}
        </text>
      )}
      {/* dish */}
