...
export function DoorGlyph({
  ...
  return (
    <g opacity={dim ? 0.45 : 1}>
      ...
      <clipPath id={`door-clip-${label ?? ''}-${x}-${y}`}>
        <rect x={ix} y={iy} width={iw} height={ih} rx={r * 0.6} />
      </clipPath>
      ...
      <g
        style={{
          transform: `scaleX(${Math.max(0.04, 1 - open)})`,
...
export function CarGlyph({ x, y, w, h }: { x: number; y: number; w: number; h: number }): ReactNode {
  const X = (f: number): number => x + w * f,
    Y = (f: number): number => y + h * f;
  ...
  return (
    <g>
      ...
      {/* windows */}
      <path
        d={`M${X(0.34)},${Y(0.45)} Q${X(0.39)},${Y(0.31)} ${X(0.49)},${Y(0.31)} L${X(0.49)},${Y(0.45)} Z`}
        fill="color-mix(in oklab, var(--stage-bg) 70%, var(--stage-fg))"
        opacity={0.85}
      />
      <path
        d={`M${X(0.52)},${Y(0.31)} L${X(0.62)},${Y(0.32)} Q${X(0.67)},${Y(0.34)} ${X(0.71)},${Y(0.45)} L${X(0.52)},${Y(0.45)} Z`}
        fill="color-mix(in oklab, var(--stage-bg) 70%, var(--stage-fg))"
        opacity={0.85}
      />
      {/* body sheen */}
      <path
        d={`M${X(0.14)},${Y(0.56)} L${X(0.86)},${Y(0.56)}`}
        stroke={SHEEN}
        strokeWidth={h * 0.03}
        strokeLinecap="round"
        opacity={0.55}
...
export function GoatGlyph({ x, y, w, h }: { x: number; y: number; w: number; h: number }): ReactNode {
  ...
  return (
    <g>
      ...
      <path
        d={`M${X(0.4)},${Y(0.28)} C${X(0.3)},${Y(0.16)} ${X(0.18)},${Y(0.1)} ${X(0.1)},${Y(0.16)}`}
        fill="none"
        stroke={horn}
        strokeWidth={hw}
        strokeLinecap="round"
      />
      <path
        d={`M${X(0.6)},${Y(0.28)} C${X(0.7)},${Y(0.16)} ${X(0.82)},${Y(0.1)} ${X(0.9)},${Y(0.16)}`}
        fill="none"
        stroke={horn}
        strokeWidth={hw}
        strokeLinecap="round"
      ...
      {/* floppy ears */}
      <path
        d={`M${X(0.3)},${Y(0.4)} Q${X(0.12)},${Y(0.46)} ${X(0.16)},${Y(0.6)} Q${X(0.28)},${Y(0.56)} ${X(0.34)},${Y(0.48)} Z`}
        fill={dark}
      />
      <path
        d={`M${X(0.7)},${Y(0.4)} Q${X(0.88)},${Y(0.46)} ${X(0.84)},${Y(0.6)} Q${X(0.72)},${Y(0.56)} ${X(0.66)},${Y(0.48)} Z`}
        fill={dark}
      />
      {/* long face tapering to a muzzle */}
      <path
        d={`M${X(0.36)},${Y(0.34)} Q${X(0.5)},${Y(0.28)} ${X(0.64)},${Y(0.34)} L${X(0.6)},${Y(0.74)} Q${X(0.5)},${Y(0.86)} ${X(0.4)},${Y(0.74)} Z`}
        fill={fur}
        stroke={dark}
        strokeWidth={1.5}
        strokeLinejoin="round"
      ...
      {/* beard tuft */}
      <path
        d={`M${X(0.42)},${Y(0.8)} Q${X(0.5)},${Y(1.02)} ${X(0.58)},${Y(0.8)} Q${X(0.5)},${Y(0.88)} ${X(0.42)},${Y(0.8)} Z`}
        fill={fur}
        stroke={dark}
        strokeWidth={1}
      />
