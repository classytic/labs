...
export function ReactionFlow({
  ...
  if (arrow === 'right') {
    nodes.push(
      <g key="arr">
        <line x1={ax} y1={cy} x2={ax + ARROW - 12} y2={cy} stroke="var(--stage-fg)" strokeWidth={2.5} />
        <polygon
    ...
    nodes.push(
      <g key="arr">
        <line x1={ax + 12} y1={cy} x2={ax + ARROW} y2={cy} stroke="var(--stage-fg)" strokeWidth={2.5} />
        <polygon
