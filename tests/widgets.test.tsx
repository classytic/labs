...
import { OrbitLab, GravityDrop, RiverBoat } from '../dist/physics/index.mjs';
// projectile-lab is migrated → tested under tests/labs/physics/projectile/ (from src).
